...
const (
	...
	TypeFill                  = "Fill"
	TypeFunding               = "Funding"
	TypeHyperunitOperation    = "HyperunitOperation"
	...
	TypeTwapSliceFill         = "TwapSliceFill"
...
// HyperunitOperationMutation represents an operation that mutates the HyperunitOperation nodes in the graph.
type HyperunitOperationMutation struct {
	config
	op                     Op
	typ                    string
	id                     *int
	...
	op_created_at          *time.Time
	broadcast_at           *time.Time
	state_updated_at       *time.Time
	clearedFields          map[string]struct{}
	done                   bool
	oldValue               func(context.Context) (*HyperunitOperation, error)
	predicates             []predicate.HyperunitOperation
}

var _ ent.Mutation = (*HyperunitOperationMutation)(nil)

// hyperunitoperationOption allows management of the mutation configuration using functional options.
type hyperunitoperationOption func(*HyperunitOperationMutation)

// newHyperunitOperationMutation creates new mutation for the HyperunitOperation entity.
func newHyperunitOperationMutation(c config, op Op, opts ...hyperunitoperationOption) *HyperunitOperationMutation {
	m := &HyperunitOperationMutation{
		config:        c,
		op:            op,
		typ:           TypeHyperunitOperation,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withHyperunitOperationID sets the ID field of the mutation.
func withHyperunitOperationID(id int) hyperunitoperationOption {
	return func(m *HyperunitOperationMutation) {
		var (
			err   error
			once  sync.Once
			value *HyperunitOperation
		)
		m.oldValue = func(ctx context.Context) (*HyperunitOperation, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().HyperunitOperation.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withHyperunitOperation sets the old HyperunitOperation of the mutation.
func withHyperunitOperation(node *HyperunitOperation) hyperunitoperationOption {
	return func(m *HyperunitOperationMutation) {
		m.oldValue = func(context.Context) (*HyperunitOperation, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m HyperunitOperationMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m HyperunitOperationMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *HyperunitOperationMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *HyperunitOperationMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().HyperunitOperation.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetAddress sets the "address" field.
func (m *HyperunitOperationMutation) SetAddress(s string) {
	m.address = &s
}

// Address returns the value of the "address" field in the mutation.
func (m *HyperunitOperationMutation) Address() (r string, exists bool) {
	v := m.address
	if v == nil {
		return
	}
...
// OldAddress returns the old "address" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAddress is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAddress resets all changes to the "address" field.
func (m *HyperunitOperationMutation) ResetAddress() {
	m.address = nil
}

// SetOperationID sets the "operation_id" field.
func (m *HyperunitOperationMutation) SetOperationID(s string) {
	m.operation_id = &s
}

// OperationID returns the value of the "operation_id" field in the mutation.
func (m *HyperunitOperationMutation) OperationID() (r string, exists bool) {
	v := m.operation_id
	if v == nil {
		return
	}
...
// OldOperationID returns the old "operation_id" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldOperationID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HyperunitOperationMutation) ResetOperationID() {
	m.operation_id = nil
}

// SetSourceChain sets the "source_chain" field.
func (m *HyperunitOperationMutation) SetSourceChain(s string) {
	m.source_chain = &s
}

// SourceChain returns the value of the "source_chain" field in the mutation.
func (m *HyperunitOperationMutation) SourceChain() (r string, exists bool) {
	v := m.source_chain
	if v == nil {
		return
	}
...
// OldSourceChain returns the old "source_chain" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldSourceChain(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSourceChain is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSourceChain requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSourceChain: %w", err)
	}
	return oldValue.SourceChain, nil
}

// ResetSourceChain resets all changes to the "source_chain" field.
func (m *HyperunitOperationMutation) ResetSourceChain() {
	m.source_chain = nil
}

// SetSourceAmount sets the "source_amount" field.
func (m *HyperunitOperationMutation) SetSourceAmount(s string) {
	m.source_amount = &s
}

// SourceAmount returns the value of the "source_amount" field in the mutation.
func (m *HyperunitOperationMutation) SourceAmount() (r string, exists bool) {
	v := m.source_amount
	if v == nil {
		return
	}
...
// OldSourceAmount returns the old "source_amount" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldSourceAmount(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HyperunitOperationMutation) ResetSourceAmount() {
	m.source_amount = nil
}

// SetSourceAddress sets the "source_address" field.
func (m *HyperunitOperationMutation) SetSourceAddress(s string) {
	m.source_address = &s
}

// SourceAddress returns the value of the "source_address" field in the mutation.
func (m *HyperunitOperationMutation) SourceAddress() (r string, exists bool) {
	v := m.source_address
	if v == nil {
		return
	}
...
// OldSourceAddress returns the old "source_address" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldSourceAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HyperunitOperationMutation) ResetSourceAddress() {
	m.source_address = nil
}

// SetSourceTxHash sets the "source_tx_hash" field.
func (m *HyperunitOperationMutation) SetSourceTxHash(s string) {
	m.source_tx_hash = &s
}

// SourceTxHash returns the value of the "source_tx_hash" field in the mutation.
func (m *HyperunitOperationMutation) SourceTxHash() (r string, exists bool) {
	v := m.source_tx_hash
	if v == nil {
		return
	}
...
// OldSourceTxHash returns the old "source_tx_hash" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldSourceTxHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSourceTxHash is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSourceTxHash requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSourceTxHash: %w", err)
	}
	return oldValue.SourceTxHash, nil
}

// ResetSourceTxHash resets all changes to the "source_tx_hash" field.
func (m *HyperunitOperationMutation) ResetSourceTxHash() {
	m.source_tx_hash = nil
}

// SetDestinationTxHash sets the "destination_tx_hash" field.
func (m *HyperunitOperationMutation) SetDestinationTxHash(s string) {
	m.destination_tx_hash = &s
}

// DestinationTxHash returns the value of the "destination_tx_hash" field in the mutation.
func (m *HyperunitOperationMutation) DestinationTxHash() (r string, exists bool) {
	v := m.destination_tx_hash
	if v == nil {
		return
	}
	return *v, true
...
// OldDestinationTxHash returns the old "destination_tx_hash" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldDestinationTxHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDestinationTxHash is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldDestinationTxHash requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldDestinationTxHash: %w", err)
	}
	return oldValue.DestinationTxHash, nil
}

// ResetDestinationTxHash resets all changes to the "destination_tx_hash" field.
func (m *HyperunitOperationMutation) ResetDestinationTxHash() {
	m.destination_tx_hash = nil
}

// SetDestinationFeeAmount sets the "destination_fee_amount" field.
func (m *HyperunitOperationMutation) SetDestinationFeeAmount(s string) {
	m.destination_fee_amount = &s
}

// DestinationFeeAmount returns the value of the "destination_fee_amount" field in the mutation.
func (m *HyperunitOperationMutation) DestinationFeeAmount() (r string, exists bool) {
	v := m.destination_fee_amount
	if v == nil {
		return
	}
	return *v, true
...
// OldDestinationFeeAmount returns the old "destination_fee_amount" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldDestinationFeeAmount(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDestinationFeeAmount is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldDestinationFeeAmount requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldDestinationFeeAmount: %w", err)
	}
	return oldValue.DestinationFeeAmount, nil
}

// ResetDestinationFeeAmount resets all changes to the "destination_fee_amount" field.
func (m *HyperunitOperationMutation) ResetDestinationFeeAmount() {
	m.destination_fee_amount = nil
}

// SetDestinationChain sets the "destination_chain" field.
func (m *HyperunitOperationMutation) SetDestinationChain(s string) {
	m.destination_chain = &s
}

// DestinationChain returns the value of the "destination_chain" field in the mutation.
func (m *HyperunitOperationMutation) DestinationChain() (r string, exists bool) {
	v := m.destination_chain
	if v == nil {
		return
	}
	return *v, true
...
// OldDestinationChain returns the old "destination_chain" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldDestinationChain(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDestinationChain is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldDestinationChain requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldDestinationChain: %w", err)
	}
	return oldValue.DestinationChain, nil
}

// ResetDestinationChain resets all changes to the "destination_chain" field.
func (m *HyperunitOperationMutation) ResetDestinationChain() {
	m.destination_chain = nil
}

// SetDestinationAddress sets the "destination_address" field.
func (m *HyperunitOperationMutation) SetDestinationAddress(s string) {
	m.destination_address = &s
}

// DestinationAddress returns the value of the "destination_address" field in the mutation.
func (m *HyperunitOperationMutation) DestinationAddress() (r string, exists bool) {
...
// OldDestinationAddress returns the old "destination_address" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldDestinationAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HyperunitOperationMutation) ResetDestinationAddress() {
	m.destination_address = nil
}

// SetSweepFeeAmount sets the "sweep_fee_amount" field.
func (m *HyperunitOperationMutation) SetSweepFeeAmount(s string) {
	m.sweep_fee_amount = &s
}

// SweepFeeAmount returns the value of the "sweep_fee_amount" field in the mutation.
func (m *HyperunitOperationMutation) SweepFeeAmount() (r string, exists bool) {
	v := m.sweep_fee_amount
	if v == nil {
		return
	}
	return *v, true
...
// OldSweepFeeAmount returns the old "sweep_fee_amount" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldSweepFeeAmount(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSweepFeeAmount is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSweepFeeAmount requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSweepFeeAmount: %w", err)
	}
	return oldValue.SweepFeeAmount, nil
}

// ResetSweepFeeAmount resets all changes to the "sweep_fee_amount" field.
func (m *HyperunitOperationMutation) ResetSweepFeeAmount() {
	m.sweep_fee_amount = nil
}

// SetOpCreatedAt sets the "op_created_at" field.
func (m *HyperunitOperationMutation) SetOpCreatedAt(t time.Time) {
	m.op_created_at = &t
}

// OpCreatedAt returns the value of the "op_created_at" field in the mutation.
func (m *HyperunitOperationMutation) OpCreatedAt() (r time.Time, exists bool) {
	v := m.op_created_at
	if v == nil {
		return
	}
...
// OldOpCreatedAt returns the old "op_created_at" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldOpCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOpCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldOpCreatedAt requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldOpCreatedAt: %w", err)
	}
	return oldValue.OpCreatedAt, nil
}

// ResetOpCreatedAt resets all changes to the "op_created_at" field.
func (m *HyperunitOperationMutation) ResetOpCreatedAt() {
	m.op_created_at = nil
}

// SetBroadcastAt sets the "broadcast_at" field.
func (m *HyperunitOperationMutation) SetBroadcastAt(t time.Time) {
	m.broadcast_at = &t
}

// BroadcastAt returns the value of the "broadcast_at" field in the mutation.
func (m *HyperunitOperationMutation) BroadcastAt() (r time.Time, exists bool) {
	v := m.broadcast_at
	if v == nil {
		return
	}
...
// OldBroadcastAt returns the old "broadcast_at" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldBroadcastAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *HyperunitOperationMutation) ResetBroadcastAt() {
	m.broadcast_at = nil
}

// SetStateUpdatedAt sets the "state_updated_at" field.
func (m *HyperunitOperationMutation) SetStateUpdatedAt(t time.Time) {
	m.state_updated_at = &t
}

// StateUpdatedAt returns the value of the "state_updated_at" field in the mutation.
func (m *HyperunitOperationMutation) StateUpdatedAt() (r time.Time, exists bool) {
	v := m.state_updated_at
	if v == nil {
		return
	}
	return *v, true
...
// OldStateUpdatedAt returns the old "state_updated_at" field's value of the HyperunitOperation entity.
// If the HyperunitOperation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *HyperunitOperationMutation) OldStateUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStateUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldStateUpdatedAt requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldStateUpdatedAt: %w", err)
	}
	return oldValue.StateUpdatedAt, nil
}

// ResetStateUpdatedAt resets all changes to the "state_updated_at" field.
func (m *HyperunitOperationMutation) ResetStateUpdatedAt() {
	m.state_updated_at = nil
}

// Where appends a list predicates to the HyperunitOperationMutation builder.
func (m *HyperunitOperationMutation) Where(ps ...predicate.HyperunitOperation) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the HyperunitOperationMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *HyperunitOperationMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.HyperunitOperation, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *HyperunitOperationMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *HyperunitOperationMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (HyperunitOperation).
func (m *HyperunitOperationMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *HyperunitOperationMutation) Fields() []string {
	fields := make([]string, 0, 14)
	if m.address != nil {
		fields = append(fields, hyperunitoperation.FieldAddress)
	}
	if m.operation_id != nil {
		fields = append(fields, hyperunitoperation.FieldOperationID)
	}
	if m.source_chain != nil {
		fields = append(fields, hyperunitoperation.FieldSourceChain)
	}
	if m.source_amount != nil {
		fields = append(fields, hyperunitoperation.FieldSourceAmount)
	}
	if m.source_address != nil {
		fields = append(fields, hyperunitoperation.FieldSourceAddress)
	}
	if m.source_tx_hash != nil {
		fields = append(fields, hyperunitoperation.FieldSourceTxHash)
	}
	if m.destination_tx_hash != nil {
		fields = append(fields, hyperunitoperation.FieldDestinationTxHash)
	}
	if m.destination_fee_amount != nil {
		fields = append(fields, hyperunitoperation.FieldDestinationFeeAmount)
	}
	if m.destination_chain != nil {
		fields = append(fields, hyperunitoperation.FieldDestinationChain)
	}
	if m.destination_address != nil {
		fields = append(fields, hyperunitoperation.FieldDestinationAddress)
	}
	if m.sweep_fee_amount != nil {
		fields = append(fields, hyperunitoperation.FieldSweepFeeAmount)
	}
	if m.op_created_at != nil {
		fields = append(fields, hyperunitoperation.FieldOpCreatedAt)
	}
	if m.broadcast_at != nil {
		fields = append(fields, hyperunitoperation.FieldBroadcastAt)
	}
	if m.state_updated_at != nil {
		fields = append(fields, hyperunitoperation.FieldStateUpdatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *HyperunitOperationMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *HyperunitOperationMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case hyperunitoperation.FieldAddress:
		return m.OldAddress(ctx)
	case hyperunitoperation.FieldOperationID:
	...
	case hyperunitoperation.FieldSourceChain:
		return m.OldSourceChain(ctx)
	case hyperunitoperation.FieldSourceAmount:
		return m.OldSourceAmount(ctx)
	case hyperunitoperation.FieldSourceAddress:
		return m.OldSourceAddress(ctx)
	case hyperunitoperation.FieldSourceTxHash:
		return m.OldSourceTxHash(ctx)
	case hyperunitoperation.FieldDestinationTxHash:
		return m.OldDestinationTxHash(ctx)
	case hyperunitoperation.FieldDestinationFeeAmount:
		return m.OldDestinationFeeAmount(ctx)
	case hyperunitoperation.FieldDestinationChain:
		return m.OldDestinationChain(ctx)
	case hyperunitoperation.FieldDestinationAddress:
		return m.OldDestinationAddress(ctx)
	case hyperunitoperation.FieldSweepFeeAmount:
		return m.OldSweepFeeAmount(ctx)
	case hyperunitoperation.FieldOpCreatedAt:
		return m.OldOpCreatedAt(ctx)
	case hyperunitoperation.FieldBroadcastAt:
		return m.OldBroadcastAt(ctx)
	case hyperunitoperation.FieldStateUpdatedAt:
		return m.OldStateUpdatedAt(ctx)
	}
	return nil, fmt.Errorf("unknown HyperunitOperation field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *HyperunitOperationMutation) SetField(name string, value ent.Value) error {
	switch name {
	case hyperunitoperation.FieldAddress:
		v, ok := value.(string)
		if !ok {
	...
	case hyperunitoperation.FieldStateUpdatedAt:
		...
		m.SetStateUpdatedAt(v)
		return nil
	}
	return fmt.Errorf("unknown HyperunitOperation field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *HyperunitOperationMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *HyperunitOperationMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *HyperunitOperationMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown HyperunitOperation numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *HyperunitOperationMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *HyperunitOperationMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *HyperunitOperationMutation) ClearField(name string) error {
	return fmt.Errorf("unknown HyperunitOperation nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *HyperunitOperationMutation) ResetField(name string) error {
	switch name {
	case hyperunitoperation.FieldAddress:
		m.ResetAddress()
		return nil
	...
	case hyperunitoperation.FieldSourceTxHash:
		...
		return nil
	case hyperunitoperation.FieldDestinationTxHash:
		m.ResetDestinationTxHash()
		return nil
	case hyperunitoperation.FieldDestinationFeeAmount:
		m.ResetDestinationFeeAmount()
		return nil
	case hyperunitoperation.FieldDestinationChain:
		m.ResetDestinationChain()
		return nil
	case hyperunitoperation.FieldDestinationAddress:
		m.ResetDestinationAddress()
		return nil
	case hyperunitoperation.FieldSweepFeeAmount:
		m.ResetSweepFeeAmount()
		return nil
	case hyperunitoperation.FieldOpCreatedAt:
		m.ResetOpCreatedAt()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *HyperunitOperationMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *HyperunitOperationMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *HyperunitOperationMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *HyperunitOperationMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *HyperunitOperationMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *HyperunitOperationMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *HyperunitOperationMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown HyperunitOperation unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *HyperunitOperationMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown HyperunitOperation edge %s", name)
}
...
// TwapSliceFillMutation represents an operation that mutates the TwapSliceFill nodes in the graph.
type TwapSliceFillMutation struct {
	config
	op             Op
	typ            string
	id             *int
	...
	oldValue       func(context.Context) (*TwapSliceFill, error)
	predicates     []predicate.TwapSliceFill
}

var _ ent.Mutation = (*TwapSliceFillMutation)(nil)

// twapslicefillOption allows management of the mutation configuration using functional options.
type twapslicefillOption func(*TwapSliceFillMutation)

// newTwapSliceFillMutation creates new mutation for the TwapSliceFill entity.
func newTwapSliceFillMutation(c config, op Op, opts ...twapslicefillOption) *TwapSliceFillMutation {
	m := &TwapSliceFillMutation{
		config:        c,
		op:            op,
		typ:           TypeTwapSliceFill,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withTwapSliceFillID sets the ID field of the mutation.
func withTwapSliceFillID(id int) twapslicefillOption {
	return func(m *TwapSliceFillMutation) {
		var (
			err   error
			once  sync.Once
			value *TwapSliceFill
		)
		m.oldValue = func(ctx context.Context) (*TwapSliceFill, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().TwapSliceFill.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withTwapSliceFill sets the old TwapSliceFill of the mutation.
func withTwapSliceFill(node *TwapSliceFill) twapslicefillOption {
	return func(m *TwapSliceFillMutation) {
		m.oldValue = func(context.Context) (*TwapSliceFill, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m TwapSliceFillMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m TwapSliceFillMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *TwapSliceFillMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *TwapSliceFillMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().TwapSliceFill.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCoin sets the "coin" field.
func (m *TwapSliceFillMutation) SetCoin(s string) {
	m.coin = &s
}

// Coin returns the value of the "coin" field in the mutation.
func (m *TwapSliceFillMutation) Coin() (r string, exists bool) {
	v := m.coin
	if v == nil {
		return
	}
...
// OldCoin returns the old "coin" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldCoin(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCoin is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCoin resets all changes to the "coin" field.
func (m *TwapSliceFillMutation) ResetCoin() {
	m.coin = nil
}

// SetAddress sets the "address" field.
func (m *TwapSliceFillMutation) SetAddress(s string) {
	m.address = &s
}

// Address returns the value of the "address" field in the mutation.
func (m *TwapSliceFillMutation) Address() (r string, exists bool) {
	v := m.address
	if v == nil {
		return
	}
...
// OldAddress returns the old "address" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAddress is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAddress resets all changes to the "address" field.
func (m *TwapSliceFillMutation) ResetAddress() {
	m.address = nil
}

// SetPx sets the "px" field.
func (m *TwapSliceFillMutation) SetPx(s string) {
	m.px = &s
}

// Px returns the value of the "px" field in the mutation.
func (m *TwapSliceFillMutation) Px() (r string, exists bool) {
	v := m.px
	if v == nil {
		return
	}
...
// OldPx returns the old "px" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldPx(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPx is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPx resets all changes to the "px" field.
func (m *TwapSliceFillMutation) ResetPx() {
	m.px = nil
}

// SetSz sets the "sz" field.
func (m *TwapSliceFillMutation) SetSz(s string) {
	m.sz = &s
}

// Sz returns the value of the "sz" field in the mutation.
func (m *TwapSliceFillMutation) Sz() (r string, exists bool) {
	v := m.sz
	if v == nil {
		return
	}
...
// OldSz returns the old "sz" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldSz(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSz is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetSz resets all changes to the "sz" field.
func (m *TwapSliceFillMutation) ResetSz() {
	m.sz = nil
}

// SetSide sets the "side" field.
func (m *TwapSliceFillMutation) SetSide(s string) {
	m.side = &s
}

// Side returns the value of the "side" field in the mutation.
func (m *TwapSliceFillMutation) Side() (r string, exists bool) {
	v := m.side
	if v == nil {
		return
	}
...
// OldSide returns the old "side" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldSide(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSide is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetSide resets all changes to the "side" field.
func (m *TwapSliceFillMutation) ResetSide() {
	m.side = nil
}

// SetTime sets the "time" field.
func (m *TwapSliceFillMutation) SetTime(i int64) {
	m.time = &i
	m.addtime = nil
}

// Time returns the value of the "time" field in the mutation.
func (m *TwapSliceFillMutation) Time() (r int64, exists bool) {
	v := m.time
	if v == nil {
		return
	}
...
// OldTime returns the old "time" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldTime(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldTime is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddTime adds i to the "time" field.
func (m *TwapSliceFillMutation) AddTime(i int64) {
	if m.addtime != nil {
		*m.addtime += i
	} else {
		m.addtime = &i
...
// AddedTime returns the value that was added to the "time" field in this mutation.
func (m *TwapSliceFillMutation) AddedTime() (r int64, exists bool) {
	v := m.addtime
	if v == nil {
		return
	}
...
// ResetTime resets all changes to the "time" field.
func (m *TwapSliceFillMutation) ResetTime() {
	m.time = nil
	m.addtime = nil
}

// SetStartPosition sets the "start_position" field.
func (m *TwapSliceFillMutation) SetStartPosition(s string) {
	m.start_position = &s
}

// StartPosition returns the value of the "start_position" field in the mutation.
func (m *TwapSliceFillMutation) StartPosition() (r string, exists bool) {
	v := m.start_position
	if v == nil {
		return
	}
...
// OldStartPosition returns the old "start_position" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldStartPosition(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStartPosition is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStartPosition resets all changes to the "start_position" field.
func (m *TwapSliceFillMutation) ResetStartPosition() {
	m.start_position = nil
}

// SetClosedPnl sets the "closed_pnl" field.
func (m *TwapSliceFillMutation) SetClosedPnl(s string) {
	m.closed_pnl = &s
}

// ClosedPnl returns the value of the "closed_pnl" field in the mutation.
func (m *TwapSliceFillMutation) ClosedPnl() (r string, exists bool) {
	v := m.closed_pnl
	if v == nil {
		return
	}
...
// OldClosedPnl returns the old "closed_pnl" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldClosedPnl(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldClosedPnl is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetClosedPnl resets all changes to the "closed_pnl" field.
func (m *TwapSliceFillMutation) ResetClosedPnl() {
	m.closed_pnl = nil
}

// SetDir sets the "dir" field.
func (m *TwapSliceFillMutation) SetDir(s string) {
	m.dir = &s
}

// Dir returns the value of the "dir" field in the mutation.
func (m *TwapSliceFillMutation) Dir() (r string, exists bool) {
	v := m.dir
	if v == nil {
		return
	}
...
// OldDir returns the old "dir" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldDir(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDir is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetDir resets all changes to the "dir" field.
func (m *TwapSliceFillMutation) ResetDir() {
	m.dir = nil
}

// SetHash sets the "hash" field.
func (m *TwapSliceFillMutation) SetHash(s string) {
	m.hash = &s
}

// Hash returns the value of the "hash" field in the mutation.
func (m *TwapSliceFillMutation) Hash() (r string, exists bool) {
	v := m.hash
	if v == nil {
		return
	}
...
// OldHash returns the old "hash" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldHash(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldHash is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetHash resets all changes to the "hash" field.
func (m *TwapSliceFillMutation) ResetHash() {
	m.hash = nil
}

// SetCrossed sets the "crossed" field.
func (m *TwapSliceFillMutation) SetCrossed(b bool) {
	m.crossed = &b
}

// Crossed returns the value of the "crossed" field in the mutation.
func (m *TwapSliceFillMutation) Crossed() (r bool, exists bool) {
	v := m.crossed
	if v == nil {
		return
	}
...
// OldCrossed returns the old "crossed" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldCrossed(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCrossed is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCrossed resets all changes to the "crossed" field.
func (m *TwapSliceFillMutation) ResetCrossed() {
	m.crossed = nil
}

// SetFee sets the "fee" field.
func (m *TwapSliceFillMutation) SetFee(s string) {
	m.fee = &s
}

// Fee returns the value of the "fee" field in the mutation.
func (m *TwapSliceFillMutation) Fee() (r string, exists bool) {
	v := m.fee
	if v == nil {
		return
	}
...
// OldFee returns the old "fee" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldFee(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldFee is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetFee resets all changes to the "fee" field.
func (m *TwapSliceFillMutation) ResetFee() {
	m.fee = nil
}

// SetOid sets the "oid" field.
func (m *TwapSliceFillMutation) SetOid(i int64) {
	m.oid = &i
	m.addoid = nil
}

// Oid returns the value of the "oid" field in the mutation.
func (m *TwapSliceFillMutation) Oid() (r int64, exists bool) {
	v := m.oid
	if v == nil {
		return
	}
...
// OldOid returns the old "oid" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldOid(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldOid is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddOid adds i to the "oid" field.
func (m *TwapSliceFillMutation) AddOid(i int64) {
	if m.addoid != nil {
		*m.addoid += i
	} else {
		m.addoid = &i
...
// AddedOid returns the value that was added to the "oid" field in this mutation.
func (m *TwapSliceFillMutation) AddedOid() (r int64, exists bool) {
	v := m.addoid
	if v == nil {
		return
	}
...
// ResetOid resets all changes to the "oid" field.
func (m *TwapSliceFillMutation) ResetOid() {
	m.oid = nil
	m.addoid = nil
}

// SetTid sets the "tid" field.
func (m *TwapSliceFillMutation) SetTid(i int64) {
	m.tid = &i
	m.addtid = nil
}

// Tid returns the value of the "tid" field in the mutation.
func (m *TwapSliceFillMutation) Tid() (r int64, exists bool) {
	v := m.tid
	if v == nil {
		return
	}
...
// OldTid returns the old "tid" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldTid(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldTid is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddTid adds i to the "tid" field.
func (m *TwapSliceFillMutation) AddTid(i int64) {
	if m.addtid != nil {
		*m.addtid += i
	} else {
		m.addtid = &i
...
// AddedTid returns the value that was added to the "tid" field in this mutation.
func (m *TwapSliceFillMutation) AddedTid() (r int64, exists bool) {
	v := m.addtid
	if v == nil {
		return
	}
...
// ResetTid resets all changes to the "tid" field.
func (m *TwapSliceFillMutation) ResetTid() {
	m.tid = nil
	m.addtid = nil
}

// SetTwapID sets the "twap_id" field.
func (m *TwapSliceFillMutation) SetTwapID(i int64) {
	m.twap_id = &i
	m.addtwap_id = nil
}

// TwapID returns the value of the "twap_id" field in the mutation.
func (m *TwapSliceFillMutation) TwapID() (r int64, exists bool) {
	v := m.twap_id
	if v == nil {
		return
	}
...
// OldTwapID returns the old "twap_id" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldTwapID(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldTwapID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldTwapID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldTwapID: %w", err)
	}
	return oldValue.TwapID, nil
}

// AddTwapID adds i to the "twap_id" field.
func (m *TwapSliceFillMutation) AddTwapID(i int64) {
	if m.addtwap_id != nil {
		*m.addtwap_id += i
	} else {
		m.addtwap_id = &i
...
// AddedTwapID returns the value that was added to the "twap_id" field in this mutation.
func (m *TwapSliceFillMutation) AddedTwapID() (r int64, exists bool) {
	v := m.addtwap_id
	if v == nil {
		return
	}
...
// ResetTwapID resets all changes to the "twap_id" field.
func (m *TwapSliceFillMutation) ResetTwapID() {
	m.twap_id = nil
	m.addtwap_id = nil
}

// SetFeeToken sets the "fee_token" field.
func (m *TwapSliceFillMutation) SetFeeToken(s string) {
	m.fee_token = &s
}

// FeeToken returns the value of the "fee_token" field in the mutation.
func (m *TwapSliceFillMutation) FeeToken() (r string, exists bool) {
	v := m.fee_token
	if v == nil {
		return
	}
...
// OldFeeToken returns the old "fee_token" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldFeeToken(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldFeeToken is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetFeeToken resets all changes to the "fee_token" field.
func (m *TwapSliceFillMutation) ResetFeeToken() {
	m.fee_token = nil
}

// SetBuilderFee sets the "builder_fee" field.
func (m *TwapSliceFillMutation) SetBuilderFee(s string) {
	m.builder_fee = &s
}

// BuilderFee returns the value of the "builder_fee" field in the mutation.
func (m *TwapSliceFillMutation) BuilderFee() (r string, exists bool) {
	v := m.builder_fee
	if v == nil {
		return
	}
...
// OldBuilderFee returns the old "builder_fee" field's value of the TwapSliceFill entity.
// If the TwapSliceFill object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TwapSliceFillMutation) OldBuilderFee(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldBuilderFee is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ClearBuilderFee clears the value of the "builder_fee" field.
func (m *TwapSliceFillMutation) ClearBuilderFee() {
	m.builder_fee = nil
	m.clearedFields[twapslicefill.FieldBuilderFee] = struct{}{}
}

// BuilderFeeCleared returns if the "builder_fee" field was cleared in this mutation.
func (m *TwapSliceFillMutation) BuilderFeeCleared() bool {
	_, ok := m.clearedFields[twapslicefill.FieldBuilderFee]
	return ok
}

// ResetBuilderFee resets all changes to the "builder_fee" field.
func (m *TwapSliceFillMutation) ResetBuilderFee() {
	m.builder_fee = nil
	delete(m.clearedFields, twapslicefill.FieldBuilderFee)
}

// Where appends a list predicates to the TwapSliceFillMutation builder.
func (m *TwapSliceFillMutation) Where(ps ...predicate.TwapSliceFill) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the TwapSliceFillMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *TwapSliceFillMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.TwapSliceFill, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *TwapSliceFillMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *TwapSliceFillMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (TwapSliceFill).
func (m *TwapSliceFillMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *TwapSliceFillMutation) Fields() []string {
	fields := make([]string, 0, 17)
	if m.coin != nil {
		fields = append(fields, twapslicefill.FieldCoin)
	}
	if m.address != nil {
		fields = append(fields, twapslicefill.FieldAddress)
	}
	if m.px != nil {
		fields = append(fields, twapslicefill.FieldPx)
	}
	if m.sz != nil {
		fields = append(fields, twapslicefill.FieldSz)
	}
	if m.side != nil {
		fields = append(fields, twapslicefill.FieldSide)
	}
	if m.time != nil {
		fields = append(fields, twapslicefill.FieldTime)
	}
	if m.start_position != nil {
		fields = append(fields, twapslicefill.FieldStartPosition)
	}
	if m.closed_pnl != nil {
		fields = append(fields, twapslicefill.FieldClosedPnl)
	}
	if m.dir != nil {
		fields = append(fields, twapslicefill.FieldDir)
	}
	if m.hash != nil {
		fields = append(fields, twapslicefill.FieldHash)
	}
	if m.crossed != nil {
		fields = append(fields, twapslicefill.FieldCrossed)
	}
	if m.fee != nil {
		fields = append(fields, twapslicefill.FieldFee)
	}
	if m.oid != nil {
		fields = append(fields, twapslicefill.FieldOid)
	}
	if m.tid != nil {
		fields = append(fields, twapslicefill.FieldTid)
	}
	if m.twap_id != nil {
		fields = append(fields, twapslicefill.FieldTwapID)
	}
	if m.fee_token != nil {
		fields = append(fields, twapslicefill.FieldFeeToken)
	}
	if m.builder_fee != nil {
		fields = append(fields, twapslicefill.FieldBuilderFee)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *TwapSliceFillMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TwapSliceFillMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case twapslicefill.FieldCoin:
		return m.OldCoin(ctx)
	case twapslicefill.FieldAddress:
	...
	case twapslicefill.FieldTid:
		return m.OldTid(ctx)
	case twapslicefill.FieldTwapID:
		return m.OldTwapID(ctx)
	case twapslicefill.FieldFeeToken:
		return m.OldFeeToken(ctx)
	case twapslicefill.FieldBuilderFee:
		return m.OldBuilderFee(ctx)
	}
	return nil, fmt.Errorf("unknown TwapSliceFill field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TwapSliceFillMutation) SetField(name string, value ent.Value) error {
	switch name {
	case twapslicefill.FieldCoin:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown TwapSliceFill field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *TwapSliceFillMutation) AddedFields() []string {
	var fields []string
	if m.addtime != nil {
		fields = append(fields, twapslicefill.FieldTime)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TwapSliceFillMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case twapslicefill.FieldTime:
		return m.AddedTime()
	case twapslicefill.FieldOid:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TwapSliceFillMutation) AddField(name string, value ent.Value) error {
	switch name {
	case twapslicefill.FieldTime:
		v, ok := value.(int64)
		if !ok {
	...
	return fmt.Errorf("unknown TwapSliceFill numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *TwapSliceFillMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(twapslicefill.FieldBuilderFee) {
		fields = append(fields, twapslicefill.FieldBuilderFee)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *TwapSliceFillMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *TwapSliceFillMutation) ClearField(name string) error {
	switch name {
	case twapslicefill.FieldBuilderFee:
		m.ClearBuilderFee()
		return nil
	}
	return fmt.Errorf("unknown TwapSliceFill nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *TwapSliceFillMutation) ResetField(name string) error {
	switch name {
	case twapslicefill.FieldCoin:
		m.ResetCoin()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *TwapSliceFillMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *TwapSliceFillMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *TwapSliceFillMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TwapSliceFillMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *TwapSliceFillMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *TwapSliceFillMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *TwapSliceFillMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown TwapSliceFill unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *TwapSliceFillMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown TwapSliceFill edge %s", name)
}
